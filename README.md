...
| 实际候选、证据、来源与进度写入 SQLite | 两批共37账号；24人工通过、8客户排除、5待定；3名女生仅作种子，可用种子共27，自动通过0 |
| 真实人工反馈、规则保存、通过名单与种子读取 | 两批37条反馈已保存，规则v3；客户名单与仅作种子的女生分别读取和导出 |
| 关系扩展与自动模式 | 已沿人工通过种子发现新候选；女生种子的实际浏览扩展和自动模式仍未实测，见 [浏览器实测记录](references/ego-browser.md) |
